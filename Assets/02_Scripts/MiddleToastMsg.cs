...
public class MiddleToastMsg : MonoBehaviour
{
    public TextMeshProUGUI toast;
    float fadeInOutTime = 0.3f;
    static MiddleToastMsg instance = null;
    public static MiddleToastMsg Instance
    {
        get
        {
            if (null == instance) instance = FindObjectOfType<MiddleToastMsg>();
            return instance;
        }
    }
